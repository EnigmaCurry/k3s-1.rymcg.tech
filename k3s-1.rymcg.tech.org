...
** Postgres Deployment
#+BEGIN_COMMENT
Follow the deployment instructions in the Postgres library INCLUDE:
#+END_COMMENT
...
** Install local development requirements 
  ...
  2. Ensure essential packages are installed:
  #+begin_src shell :noweb yes :eval never-export :results output
...
You can switch to the =pyapp-uvicorn= buffer to watch the application log
output.
